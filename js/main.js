    ...
    applyStateAndRender() {
        ...
        if (this.feriaConfig && this.feriaConfig.active) {
            ...
            this.MENU_DATA.push({
                ...
                precio: activeFeriaPrices['p-patacon-caribeno'] || 4000, img: '<img src="images-catalogo/patacon_caribeno.png?v=1" alt="Patacón Caribeño" class="img-fit">'
            });
            this.MENU_DATA.push({
                ...
                precio: activeFeriaPrices['c-queso-pinto-cafe'] || 4000, img: '<img src="images-catalogo/queso_pinto_cafe.png?v=1" alt="Queso Pinto + Café" class="img-fit">', badge: 'Combo', badgeClass: 'badge-value'
            });
            ...
            if (this.feriaConfig.combos_active) {
                ...
                this.MENU_DATA.push({
                    ...
                    precio: activeFeriaPrices['ce-hamburguesa-jr-fresco'] || 2500, img: '<img src="images-catalogo/hamburguesa_jr.png?v=1" alt="Hamburguesa Jr + Té Frío" class="img-fit">'
                });
                this.MENU_DATA.push({
                    id: 'ce-hotdog-fresco', categoria: 'combos', nombre: 'Hot Dog + Té Frío',
                    desc: 'Clásico hot dog con papas tostadas, salsas y té frío.',
                    precio: activeFeriaPrices['ce-hotdog-fresco'] || 2000, img: '<img src="images-catalogo/hot_dog.png?v=1" alt="Hot Dog + Té Frío" class="img-fit">'
                });
            }
        }
